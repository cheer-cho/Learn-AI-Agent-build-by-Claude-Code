"""Tests for the Module 01 reference solution. Fully offline — no API key,
no network, and no reliance on a cached tiktoken vocabulary."""
...
explorer = import_from_path("m01_solution_explorer", MODULE_DIR / "solution" / "explorer.py")
